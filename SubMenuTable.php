		   ...
		   <div class="col-md-12" id="sc">
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Sub Menu Data</h4>
                        </div>
...
ob_start();
include("db.php"); 
$updated = mysql_query("SELECT * FROM `smain` WHERE `smain`.`flag`!='Y'");
$i=1;
while($row = mysql_fetch_array($updated))
{
  ...
  echo "<td ><a href='#' onclick=select(".$row['sid'].")><span class='badge bg-green'>Update</span></td>";
  echo "<td ><a href='#' onclick=deletes(".$row['sid'].")><span class='badge bg-red'>Delete</span></td>";
